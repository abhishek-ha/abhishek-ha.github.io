...
$('body').append("<div style=' background-color: rgba(0, 0, 0, 0.5);'>" +
    ...
    "                                <div class='mt-4'> <button id='VerifyOTPUpgradebtn'" +
...
function GetOPDPlanForUpgrade(policyNo, planCode = '') {
    return new Promise(function (resolve, reject) {
        ShowLoding(true);
        $.ajax({
            type: "GET",
            url: ProductApiBaseUrl + "api/UserOPDPlans/GetOPDPlanForUpgrade?policyNo=" + policyNo + "&planCode=" + planCode,
            dataType: "json",
            headers: {
                'Accept': 'application/json',
                'Content-Type': 'application/json',
