...
function OpenBuyPlanPopup(popuptitle, PlanCode, PartnerOrderId, CouponCode, IsUserTracker = false, IsVarifyEmail = false, EmailDomain = "", IsVarifyEmailPhoneTNC = false, IsEnableMembersAddtion = false, IsEnableAgent = false, IsEnableApplyCoupon = false) {
    $('#BuyPlaniframe').attr('src', 'https://live.healthassure.in/buyPlan/buyPlan.html?PopupTitle=' + popuptitle + '&PlanCode=' + PlanCode + '&PartnerOrderId=' + PartnerOrderId + '&CouponCode=' + CouponCode + '&IsUserTracker=' + IsUserTracker + '&utm_source=' + Vars1["utm_source"] + '&utm_medium=' + Vars1["utm_medium"] + '&utm_campaign=' + Vars1["utm_campaign"] + '&utm_term=' + Vars1['utm_term'] + '&utm_content=' + Vars1['utm_content'] + '&IsVarifyEmail=' + IsVarifyEmail + '&EmailDomain=' + EmailDomain + '&IsVarifyEmailPhoneTNC=' + IsVarifyEmailPhoneTNC + '&IsEnableMembersAddtion=' + IsEnableMembersAddtion + '&IsEnableAgent=' + IsEnableAgent + '&IsEnableApplyCoupon=' + IsEnableApplyCoupon);
    openmodal();
}
