...
(function () {
    ...
    $('body').append("<div style=' background-color: rgba(0, 0, 0, 0.5);'>" +
        ...
        "                                    <h3 class='text-center' style='font-size:23px;'> Thank you for your interest !!</h3>" +
        ...
        "                                            Buy now" +
        "                                        </button>" +
        "                                        <button id='downloadpdfbtnclosemodal' type='submit' style='margin-top: 10px;background-color: green;display: none;' data-dismiss='modal' value='Download'" +
