...
function BuyOPDPlan(Name, Email, MobileNo, DOB, Gender, PlanCode, CouponCode, description) {
    return new Promise(function (resolve, reject) {
        ...
        $.ajax({
            ...
            data: JSON.stringify({ Name: Name, Email: Email, MobileNo: MobileNo, DOB: DOB, Gender: Gender, PlanCode: PlanCode, CouponCode: CouponCode, Status: 'BuyRequest' }),
